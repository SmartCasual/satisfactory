...
RSpec.describe Satisfactory do
  describe 'an example sequence' do
    it 'creates a candidate with the correct associations' do
      ...
      expect(first_application_choice.course_option).to be_full_time
      expect(second_application_choice.course_option).to be_part_time
      expect(third_application_choice.course_option).to be_part_time
